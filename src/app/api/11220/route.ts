...
import courseList11210 from "./11220Courses.json";

const defaultData: Course[] = courseList11210 as Course[];
export const db11220 = JSONSyncPreset<Course[]>("db.json", defaultData);
...
export async function GET(request: NextRequest) {
  ...
  const courseList = db11220.data.filter((course) => {
